<?php
	...
	echo makePageStart("Talk2Us - Edit Group Support Topic");  
	echo makeNav("");
	echo makeToTop();
	echo resizeButtons();
...
<a href="manageGroups.php" class="backButton"><p><i class="fa fa-arrow-circle-left fa-1x"></i> Back</p></a>
		<h1><strong>Edit Group Support topic</strong></h1>
		<div class="formDiv"> 
			<div class="formInfo">
				<p>* Mandatory fields</p>
			</div>
			
			<form method="post" action="editGSProcess.php" id="editGSForm">
				...
				<div class="space row">
					...
					<div class="col-sm-10">		
						...
						<p id="errorTNameGS" style="color: red;"></p>
					</div>
				</div>
					
				<div class="space floatRight">
					<input type="reset" class="button" id="clearGSTopic" value="Clear">
					<input type="submit" class="button" id="submitGSTopic" value="Submit">
				</div>
				<br class="clearRight"/>
			</form> 
		</div>
