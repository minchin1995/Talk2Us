<?php
	...
	if (isset($_GET["blogid"])) {
		...
		header("Location: managePosted.php"); // redirect back if there is not blogid
	}
	...
	echo makePageStart("Talk2Us - Delete Blog");  
	echo makeNav("");
	echo makeToTop();
	echo resizeButtons();
...
<?php
	...
	if (isset($_SESSION['userID'])){
		...
		if ($accountID == "1") {
			echo "<h1><strong>Delete Blog</strong></h1>";
			if (mysqli_affected_rows($conn)>0) {
				...
				echo noexist("Blog");
				echo "<a href=\"managePosted.php\"><p>Return to manage posted blog page</p></a>";
				echo "<a href=\"manageBlog.php\"><p>Return to manage blog page</p></a>";
				echo "<a href=\"admin.php\"><p>Return to admin page</p></a>";
			}
		} else {
