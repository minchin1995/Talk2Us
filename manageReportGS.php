<?php
	...
	JOIN reportsupport ON (report.reportID=reportsupport.reportID)
	...
	echo makePageStart("Talk2Us - Manage Report(Group Support)");  
	echo makeNav("");
	echo makeToTop();
	echo resizeButtons();
...
<a href="manageReport.php" class="backButton"><p><i class="fa fa-arrow-circle-left fa-1x"></i> Back</p></a>
	<h1><strong>Manage Report (Group Support)</strong></h1>
...
<?php
				while($row = mysqli_fetch_assoc($rsRep)){
					...
					echo "<td><a href=\"editRepGS.php?postid=$postID\">EDIT</a></td>";
					echo "<td><a onClick=\"javascript: return confirm(' Are you sure you want to delete the blog: $getPost?');\" href=\"deleteGSPost.php?postid=$postID\">DELETE</a></td>";
					echo "<td><a onClick=\"javascript: return confirm(' Are you sure you want to delete the report for: $getPost?');\" href=\"deleteReportGS.php?reportid=$id\">DELETE</a></td>";		
					echo "</tr>";
				}
				echo"</tbody>";
				echo"</table>";
				...
				echo noexist("group support post reports");
